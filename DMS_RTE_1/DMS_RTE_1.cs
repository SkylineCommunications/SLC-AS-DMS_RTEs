...
namespace DMS_RTE_1
{
	...
	public class Script
	{
		...
		private void RunSafe(IEngine engine)
		{
			...
			List<TestResult> hOpenLi = new List<TestResult>();
			...
			foreach (var agent in agents)
			{
				...
				TestResult hOpenRtes = new TestResult()
				{
				...
				hOpenLi.Add(hOpenRtes);
			}

			engine.AddScriptOutput("Number Open RTEs", JsonConvert.SerializeObject(openRteLi));
			engine.AddScriptOutput("Number Half Open RTEs", JsonConvert.SerializeObject(hOpenLi));
		}
